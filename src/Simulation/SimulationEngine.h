...
public:
    ...
    void Init(int gliadinCount, int gluteninCount, int starchCount);
...
private:
    ...
    float m_RepulsionK = 12000.0f;       // Repulsion force to maintain volume
    ...
    float m_SpringExpansionRate = 0.700f; // Rate at which springs expand (Rising)
